...
Donate.MainMenu.prototype = {
	...
	create: function() {
		...
		this.add.text(this.world.width/2 - 37 * titleString.length, this.world.height/2 - 200, titleString, { font: '90pt Arial', fill: '#000' });
		
		var subtitleString = 'в поисках жены';
		this.add.text(this.world.width/2 - 18 * subtitleString.length, this.world.height/2 - 120, subtitleString, { font: '57pt Arial', fill: '#000' });
